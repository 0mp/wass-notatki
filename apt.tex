...
\begin{enumerate}
  ...
  \item
    ...
    \begin{enumerate}
      \item
        Best \wassterm{Nash equilibrium}: one with the minimum social cost.
      \item
        \wassterm{Social optimum}: joint strategy with the minimum social cost.
    \end{enumerate}

    BTW, kiedyś wychodziło $1$.

  \item
    \wassterm{price of anarchy}:
